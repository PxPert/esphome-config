...
const byte LED = 1;
const byte NEXT = D7;                   // NEXT button
const byte EJCT = D5;                   // EJECT button, open/close CD-ROM tray
const byte STOP = D3;                   // STOP button
const byte PLAY = D4;                    // PLAY button
const byte PREV = D7;                    // PREV button
