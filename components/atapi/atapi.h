...
const uint8_t atapi_fnc_open_tray[DEFAULT_PACKET_SIZE]       PROGMEM = {0x1B, 0x00, 0x00, 0x00, 0x02, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}; // Open tray
const uint8_t atapi_fnc_close_tray[DEFAULT_PACKET_SIZE]      PROGMEM = {0x1B, 0x00, 0x00, 0x00, 0x03, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}; // Close tray
const uint8_t atapi_fnc_stop_unit[DEFAULT_PACKET_SIZE]       PROGMEM = {0x1B, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}; // Stop unit
// const uint8_t atapi_fnc_start_play[DEFAULT_PACKET_SIZE]      PROGMEM = {0x47, 0x00, 0x00, 0x10, 0x28, 0x05, 0x4C, 0x1A, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}; // Start PLAY
                                                                                                                                                           // from from MSF location stored at indexes   3 to 8.
                                                                                                                                                           // See also doc. sff8020i table 76
const uint8_t atapi_fnc_pause_play[DEFAULT_PACKET_SIZE]      PROGMEM = {0x4B, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}; // PAUSE play
const uint8_t atapi_fnc_resume_play[DEFAULT_PACKET_SIZE]     PROGMEM = {0x4B, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}; // RESUME play
const uint8_t atapi_fnc_read_toc[DEFAULT_PACKET_SIZE]        PROGMEM = {0x43, 0x02, 0x00, 0x00, 0x00, 0x00, 0x00, 0xFF, 0xFF, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}; // Read TOC
const uint8_t atapi_fnc_unit_ready[DEFAULT_PACKET_SIZE]      PROGMEM = {0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}; // unit ready
const uint8_t atapi_fnc_mode_sense[DEFAULT_PACKET_SIZE]      PROGMEM = {0x5A, 0x00, 0x01, 0x00, 0x00, 0x00, 0x00, 0xFF, 0xFF, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}; // mode sense
const uint8_t atapi_fnc_read_subchannel[DEFAULT_PACKET_SIZE] PROGMEM = {0x42, 0x02, 0x40, 0x01, 0x00, 0x00, 0x00, 0xFF, 0xFF, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}; // rd subch.
const uint8_t atapi_fnc_request_sense[DEFAULT_PACKET_SIZE]   PROGMEM = {0x03, 0x00, 0x00, 0x00, 0xFF, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}; // req. sense
const uint8_t atapi_fnc_stop_disk[DEFAULT_PACKET_SIZE]       PROGMEM = {0x4E, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}; // Stop disk
...
class Atapi : public i2c::I2CDevice, public PollingComponent {
 ...
 private:
  ...
  bool sendPac_progmem(const uint8_t* packet_progmem, bool firstCall) {
    uint8_t packet[DEFAULT_PACKET_SIZE];
    memcpy_P(packet, packet_progmem, DEFAULT_PACKET_SIZE);
    return sendPac(packet, firstCall);
  }
